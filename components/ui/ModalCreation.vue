...
const messages = defineMessages({
  header: {
    id: 'component.modal.modal-create.header',
    defaultMessage: 'Create a project',
  },
  description: {
    id: 'component.modal.modal-create.description',
    defaultMessage:
      'New projects are created as drafts and can be found under your profile page.',
  },
  nameLabel: {
    id: 'component.modal.modal-create.name.label',
    defaultMessage: 'Name',
  },
  namePlaceholder: {
    id: 'component.modal.modal-create.name.placeholder',
    defaultMessage: 'Enter project name...',
  },
  slugLabel: {
    id: 'component.modal.modal-create.slug.label',
    defaultMessage: 'URL',
  },
  visibilityLabel: {
    id: 'component.modal.modal-create.visibility.label',
    defaultMessage: 'Visibility',
  },
  visibilityDescription: {
    id: 'component.modal.modal-create.visibility.description',
    defaultMessage: 'The visibility of your project after it has been approved.'
  },
  visibilityPlaceholder: {
    id: 'component.modal.modal-create.visibility.placeholder',
    defaultMessage: 'Choose visibility..',
  },
  visibilitysApproved: {
    id: 'component.modal.modal-create.visibilitys.approved',
    defaultMessage: 'Public',
  },
  visibilitysPrivate: {
    id: 'component.modal.modal-create.visibilitys.private',
    defaultMessage: 'Private',
  },
  visibilitysUnlisted: {
    id: 'component.modal.modal-create.visibilitys.unlisted',
    defaultMessage: 'Unlisted',
  },
  additionalInformationLabel: {
    id: 'component.modal.modal-create.summary.label',
    defaultMessage: 'Summary',
  },
  additionalInformationDescription: {
    id: 'component.modal.modal-create.summary.description',
  ...
  data() {
    return {
      ...
      visibilities: [
        {
          actual: 'approved',
          display: formatMessage(commonMessages.visibilitysApproved),
        },
        {
          actual: 'private',
          display: formatMessage(commonMessages.visibilitysPrivate),
        },
        {
          actual: 'unlisted',
          display: formatMessage(commonMessages.visibilitysUnlisted),
        },
      ],
      visibility: {
        actual: 'approved',
